...
def predict():
    ...
    poly = PolynomialFeatures(degree=degree_error_combo[0])
    poly_features = poly.fit_transform(x_train.to_frame())
    ...
    # for comparison: regression generated by seaborn's lmplot
    sns.lmplot(
        data=df_zip_income_mod,
        x="Median income (dollars)",
        y="Housing to Households Ratio",
    ...
    #plt.savefig("NYC_Housing_Household_vs_Income_via_lmplot.png")
    plt.show()
